...
const metricOptions = {'Fake Reviews (%)': 'fake_review_pct', 'Stars Absolute Difference (%)': 'stars_pct_diff', 'Stars Change with Fake Reviews': 'stars_delta'}
...
function createMapAndLegend(jsons, reviewData, selectedMetro, selectedCategory) {
    ...
    if (metricList.value == 'stars_delta'){ colors = d3.interpolateRgb("red", "yellow")
    } else { colors = d3.interpolateRgb("yellow", "red")};
    ...
    function getColor(zipcode) {
        if (zipcodes_category.includes(zipcode)) {
            let fake_review_pct = metrics.find(obj => {return obj.zipcode === zipcode})[metricList.value]
        ...
        map.selectAll("path")
            ...
            .on("mouseover", function (event, d) {
                ...
                if (zipcodes_category.includes(zipcode)) {
                    ...
                    tooltip.html("<b>Zipcode</b>: " + zipcode + "<br><b>Fake Review Count</b>: " + fake_review_count + "<br><b>Fake Reviews (%)</b>: " + fake_review_pct + "<br><b>Rating Difference (%)</b>: " + stars_pct_diff + "<br><b>Stars Delta Mean</b>: " + stars_delta_mean);
                ...
                } else {tooltip.html("<b>Zipcode</b>: " + zipcode + "<br><b>Fake Review Count</b>: N/A <br><b>Fake Reviews (%)</b>: N/A <br><b>Rating Difference (%)</b>: N/A <br><b>Stars Delta Mean</b>: N/A")};
